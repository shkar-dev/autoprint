...
return [
    ...
    */
    ...
    'options' => [
         ...
         * The temporary directory is required to download remote images.blade.php and when
         ...
         * Image DPI setting
         *
         * This setting determines the default DPI setting for images.blade.php and fonts.  The
         * DPI may be overridden for inline images.blade.php by explictly setting the
         * image's width & height style attributes (i.e. if the image's native
         * width is 600 pixels and you specify the image's width as 72 points,
         * the image will have a DPI of 600 in the rendered PDF.  The DPI of
         * background images.blade.php can not be overridden and is controlled entirely
         * via this parameter.
         *
         ...
         *
         * In images.blade.php, <img> size in pixel attribute, img css style, are overriding
         ...
         *  images.blade.php and CSS files as required.
         *
         *  ==== IMPORTANT ====
